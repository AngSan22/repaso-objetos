...
public class Exercise6 {
    ...
    @Test
    public void giveAnNewAlgoritmoX_whenAEqualsB_thenDependencia1IsSave(){
       //Given
        ...
        //When
        algoritmoX.algoritmoACubrir(1, 1, "hola");

        //Then
        Mockito.verify(dependencia1).save("hola");
        Mockito.verify(dependencia3).recover();
        Mockito.verifyNoMoreInteractions(dependencia1, dependencia2, dependencia3);
    }

    @Test
    public void giveAnNewAlgoritmoX_whenAIsLessThanB_thenDependencia2IsPrint(){
        //Given
        Dependencia1 dependencia1 = Mockito.mock(Dependencia1.class);
        Dependencia2 dependencia2 = Mockito.mock(Dependencia2.class);
        Dependencia3 dependencia3 = Mockito.mock(Dependencia3.class);
        ...
        //When
        algoritmoX.algoritmoACubrir(1, 2, "hola");

        //Then
        Mockito.verify(dependencia2).print(1,"hola");
        Mockito.verify(dependencia3).recover();
        Mockito.verifyNoMoreInteractions(dependencia1, dependencia2, dependencia3);
    }

    @Test
    public void giveAnNewAlgoritmoX_whenAIsMoreThanB_thenDependencia2IsPrint(){
        //Given
        Dependencia1 dependencia1 = Mockito.mock(Dependencia1.class);
        Dependencia2 dependencia2 = Mockito.mock(Dependencia2.class);
        Dependencia3 dependencia3 = Mockito.mock(Dependencia3.class);
        ...
        //When
        algoritmoX.algoritmoACubrir(2, 1, "hola");
